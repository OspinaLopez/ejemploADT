...
<title>Administrador de areas</title>
...
<body oncontextmenu="return false">
	<section>  
		<table id="dg" title="Areas" class="easyui-datagrid" style="width:800px;height:250px"
            url="areas"
		...
		<?php
			echo '<tr><td>'.$area['area_id'].'</td><td>'.$area['descripcion'].'</td></tr>';
		?>
		<?php endforeach; ?>
    </table>
    <div id="toolbar">
    ...
    <div name="dlg" id="dlg" class="easyui-dialog" style="width:300px;height:250px;padding:10px 20px"
        ...
        <div class="ftitle">Informacion Area</div>
